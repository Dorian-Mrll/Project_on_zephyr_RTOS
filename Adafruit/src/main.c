...
// #define SOC_NODE DT_NODELABEL(sercom0)
// #define NAME DT_PROP(DT_CHILD(SOC_NODE, ssd16xxfb_0), label)
...
//     //const struct gpio_dt_spec reset_gpios = GPIO_DT_SPEC_GET(DT_CHILD(DT_NODELABEL(sercom0), ssd16xxfb_0), reset_gpios);
...
//     const struct device *display_dev2 = DEVICE_DT_GET(DT_NODELABEL(sercom2));
//     const struct device *display_dev2 = device_get_binding(NAME);

// 	if (display_dev2 == NULL) {
// 		printk("Device %s not found. Aborting sample.", NAME);
// 	}
// }
