...
//     GPIO_DT_SPEC_GET_BY_IDX(DT_NODELABEL(other), gpios, 12),
//     GPIO_DT_SPEC_GET_BY_IDX(DT_NODELABEL(other), gpios, 13),

//     GPIO_DT_SPEC_GET_BY_IDX(DT_NODELABEL(other), gpios, 14),
//     GPIO_DT_SPEC_GET_BY_IDX(DT_NODELABEL(other), gpios, 15),

//     GPIO_DT_SPEC_GET_BY_IDX(DT_NODELABEL(other), gpios, 16),
//     GPIO_DT_SPEC_GET_BY_IDX(DT_NODELABEL(other), gpios, 17),
//     GPIO_DT_SPEC_GET_BY_IDX(DT_NODELABEL(other), gpios, 18),
//     GPIO_DT_SPEC_GET_BY_IDX(DT_NODELABEL(other), gpios, 19)
// }; 
